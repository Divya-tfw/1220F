...
public class Base_Salary_By_Industry extends App_Specific_Keywords
{

	/*****************************************************************************************************************
  	 * 	Author						:	Divya Raju.R
  	 * 	LastModifiedDate			:	12-6-2015  	  
  	 * 	Annotation					:	@Test
  	 * 	MethodName					: 	test_Base_Salary_By_Industry
  	 * 	Description					:	This method is used to perform required functionality test 
  	 * 									on application.
  	 * 
  	 ***************************************************************************************************************/	
	@Test(dataProvider="ExcelData")
	public void test_Base_Salary_By_Industry(Hashtable<String,String> data) 
	{
		//Start of script
		...
		//click on generate report
		 ...
		 scrollPageUp(450);
					...
					
				{
					...
					T2_DIV_TH1_TCN_ReadXLSX(GlobalVariables.testCaseIdentifier,
							GlobalVariables.testCaseIdentifier							
				 			,data.get(TestBaseConstants.SUB_REPORT_NAME),
