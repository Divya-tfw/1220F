...
public class Base_Salary_By_NAR extends App_Specific_Keywords
{
	...
	/*****************************************************************************************************************
  	 ...
  	 * 	Annotation					:	@Test
  	 * 	MethodName					: 	test_Base_Salary_By_NAR
  	 * 	Description					:	This method is used to perform required functionality test 
  	 * 									on application.
  	 * 
  	 ***************************************************************************************************************/	
	@Test(dataProvider="ExcelData")
	public void test_Base_Salary_By_NAR(Hashtable<String,String> data) 
	{
		//Start of script
