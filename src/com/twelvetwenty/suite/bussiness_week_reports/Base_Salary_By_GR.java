...
public class Base_Salary_By_GR extends App_Specific_Keywords
{
	...
	/*****************************************************************************************************************
  	 ...
  	 * 	Annotation					:	@Test
  	 * 	MethodName					: 	test_Base_Salary_By_GR
  	 * 	Description					:	This method is used to perform required functionality test 
  	 * 									on application.
  	 * 
  	 ***************************************************************************************************************/	
	@Test(dataProvider="ExcelData")
	public void test_Base_Salary_By_GR(Hashtable<String,String> data) 
	{
		//Start of script
