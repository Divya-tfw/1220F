...
public class Base_Salary_By_FA extends App_Specific_Keywords
{
	...
	/*****************************************************************************************************************
  	 ...
  	 * 	Annotation					:	@Test
  	 * 	MethodName					: 	test_Base_Salary_By_FA
  	 * 	Description					:	This method is used to perform required functionality test 
  	 * 									on application.
  	 * 
  	 ***************************************************************************************************************/	
	@Test(dataProvider="ExcelData")
	public void test_Base_Salary_By_FA(Hashtable<String,String> data) 
	{
		//Start of script
