...
public class Law_School_or_UFP extends App_Specific_Keywords  
{
	...
	/*****************************************************************************************************************
  	 ...
  	 * 	Annotation					:	@Test
  	 * 	MethodName					: 	test_Law_School_or_UFP
  	 * 	Description					:	This method is used to perform required functionality test on app
  	 * 
  	 ***************************************************************************************************************/	
	@Test(dataProvider="ExcelData")
	public void test_Law_School_or_UFP(Hashtable<String,String> data) 
	{
		//Start of script
					...
					
					{
						 ...
						 mT1_TH1_TCN_WriteXLSX(
								GlobalVariables.testCaseIdentifier
						 			...
						 			GlobalVariables.OR.getProperty("report_Law_School_or_UFP")
						 			,data.get("sSub_Report_Name"));
