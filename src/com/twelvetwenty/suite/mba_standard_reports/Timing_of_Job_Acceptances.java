...
public class Timing_of_Job_Acceptances extends App_Specific_Keywords 
{
	/******************************************************************************************************************
  	 * 	Author						:	Divya Raju.R
  	 * 	LastModifiedDate			:	19-1-2015  	  
  	 * 	Annotation					:	@Test
  	 * 	MethodName					: 	test_Timing_of_Job_Acceptances
  	 * 	Description					:	This method is used to perform required
  	 * 									 functionality test on application
  	 * 
  	 ***************************************************************************************************************/
 	@Test(dataProvider="ExcelData")
 	public void test_Timing_of_Job_Acceptances(Hashtable<String,String> data) 
 	{
		//Start of script
 ...
 try
 {
			...
			TestBaseConstants.ACTUAL_BUILD_TYPE))				
	{
		...
		mT1_TH2_TCN_ReadXLSX(GlobalVariables.testCaseIdentifier,
				GlobalVariables.testCaseIdentifier
				,GlobalVariables.OR.getProperty("report_Timing_of_First_Job_Offer")
	 			,data.get(TestBaseConstants.SUB_REPORT_NAME),
	 			"Validating contents of table "+data.get(TestBaseConstants.SUB_REPORT_NAME)+
	 			"- with excel"
				);			
	}			
 }
