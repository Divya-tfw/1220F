...
public class FTMBA extends App_Specific_Keywords
{
	/*****************************************************************************************************************
  	 * 	Author						:	Divya Raju.R
  	 * 	LastModifiedDate			:	4-6-2015  	  
  	 * 	Annotation					:	@Test
  	 * 	MethodName					: 	test_FTMBA
  	 * 	Description					:	This method is used to perform required functionality test on app
  	 * 
  	 ***************************************************************************************************************/	
	@Test(dataProvider="ExcelData")
	public void test_FTMBA(Hashtable<String,String> data) 
	{
		//Start of script
		...
		Logs.infoLog("--------Execution of test---- "+GlobalVariables.scriptName+"  Started----");	
		 try
		 {
			...
			// select job phase 
			 ...
			 // select offer timing
			 selectValueFromDropDown(
				 getObjectValue("drpdown_OfferTiming"),
				 TestBaseConstants.DROP_SELECT_USING_INDEX,
				 data.get(TestBaseConstants.OFFER_TIMING),
				 "Select offer timing-->"+data.get(TestBaseConstants.OFFER_TIMING));
