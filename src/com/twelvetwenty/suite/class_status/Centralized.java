		...
		Logs.infoLog("--------Execution of test---- "+GlobalVariables.scriptName+"  Started----");	
		 try
		 {
			...
			// select job phase 
			 ...
			 //Select college
			 selectValueFromDropDown(
					 getObjectValue(TestBaseConstants.DROP_DOWN_COLLEGE),
					 TestBaseConstants.DROP_SELECT_USING_INDEX,
					 data.get(TestBaseConstants.COLLEGE),
					 "Select college -->"+data.get(TestBaseConstants.COLLEGE));
			 if(url.contains( TestBaseConstants.SCHOOL_COLUMBIA_CENTRALISED))
			 { 
			 //Select Department
			 selectValueFromDropDown(
					 getObjectValue(TestBaseConstants.DROP_DOWN_DEPARTMENT),
					 TestBaseConstants.DROP_SELECT_USING_INDEX,
					 data.get(TestBaseConstants.DEPARTMENT),
					 "Select Department-->"+data.get(TestBaseConstants.DEPARTMENT));
			 }
