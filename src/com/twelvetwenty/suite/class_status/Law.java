...
public class Law extends App_Specific_Keywords
{
	/*****************************************************************************************************************
  	 * 	Author						:	Divya Raju.R
	...
	public void test_Law(Hashtable<String,String> data) 
	{
		//Start of script
		...
		Logs.infoLog("--------Execution of test---- "+GlobalVariables.scriptName+"  Started----");	
		 try
		 {
			...
			// select job phase 
			 ...
			 //Select Desired Employment type
			 selectValueFromDropDown(
					 getObjectValue("dpdown_EmploymentType"),
					 TestBaseConstants.DROP_SELECT_USING_INDEX,
					 data.get("sDesiredEmploymentType"),
					 "Select Desired Industry-->"+data.get("sDesiredEmploymentType"));
