...
public class Emp_Detail_by_RaceorEthnicity extends App_Specific_Keywords
{
	/*****************************************************************************************************************
  	 * 	Author						:	Divya Raju.R
  	 * 	LastModifiedDate			:	19-5-2015  	  
  	 * 	Annotation					:	@Test
  	 * 	MethodName					: 	test_Emp_Detail_by_RaceorEthnicity
  	 * 	Description					:	This method is used to perform required functionality test on app
  	 * 
  	 ***************************************************************************************************************/	
	@Test(dataProvider="ExcelData")
	public void test_Emp_Detail_by_RaceorEthnicity(Hashtable<String,String> data) 
	{
		//Start of script
 ...
 try
 {
	...
	// Launch Browser
	 ...
	 // click on table 1 A generate click
	 Thread.sleep(3000);
		...
		if(data.get("sCutoff_Date").equalsIgnoreCase("Without"))
		{
		 ...
		 //scroll the page upwards
				...
				
			{
				...
				mT1_TH2_TBH2_TCN_ReadXLSX(GlobalVariables.testCaseIdentifier,GlobalVariables.testCaseIdentifier
						,GlobalVariables.OR.getProperty("report_Nalp")
			 			,data.get("sSub_Report_Name"),
